<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"E:\phpWeb\watian\webserver\public/../application/admin\view\advert_item\index.html";i:1535120266;s:66:"E:\phpWeb\watian\webserver\application\admin\view\public\base.html";i:1538110204;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<form method="post" action="">
    <div class="panel admin-panel">
        <div class="panel-head"><strong class="icon-reorder"> 广告项列表</strong></div>
        <div class="padding border-bottom">
            <button type="button" class="button border-yellow" onclick="window.location.href='<?php echo url('add',['advertid'=>$advertid]); ?>'">
                <span class="icon-plus-square-o"></span> 添加广告项
            </button>
        </div>
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><img src="<?php echo $item['img_url']; ?>" style="width:100px;height:75px;"></td>
                ...
                <td>
                    <div class="button-group">
                        ...
                        <a class="button border-red" href="javascript:void(0)"
                           onClick="warning('确实要删除吗', '<?php echo url('del',['id'=>$item['id']]); ?>')">
