<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"E:\phpWeb\watian\webserver\public/../application/admin\view\product\product.html";i:1544602459;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form" lay-filter="product">
        ...
        <div class="white magt10">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="checkbox" name="is_free_shipping" lay-skin="switch" lay-filter="is_free_shipping" lay-text="是|否" checked>
                </div>
            </div>
            <div class="shipping">
                <div class="layui-form-item">
        ...
        <div class="white magt10">
            ...
            <div class="layui-form-item sale_time">
                ...
                <div class="layui-input-inline">
                    <input type="sale_start_time" name="upper_shelf_time" value="" placeholder="请选择上架时间" class="layui-input sale_start_time">
                </div>
...
<script type="text/javascript" src="/static/admin/client/shop/product/product.js"></script>
</body>
</html>