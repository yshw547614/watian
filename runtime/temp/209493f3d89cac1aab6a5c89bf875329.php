<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\phpWeb\watian\webserver\public/../application/admin\view\navigation\index.html";i:1532662716;s:66:"E:\phpWeb\watian\webserver\application\admin\view\public\base.html";i:1538110204;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <button type="button" class="button border-yellow" onclick="window.location.href='<?php echo url('add'); ?>'">
                <span class="icon-plus-square-o"></span> 添加导航项
            </button>
        </div>
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><img src="<?php echo $item['icon']; ?>" style="width:100px;height:75px;"></td>
