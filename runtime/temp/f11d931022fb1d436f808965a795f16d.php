<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\phpweb\watian\webserver\public/../application/admin\view\slogan\index.html";i:1538111686;s:66:"D:\phpweb\watian\webserver\application\admin\view\public\base.html";i:1538110204;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td><input name="link[]" value="<?php echo $item['link']; ?>" id="link<?php echo $item['id']; ?>" class="input w80"></td>
            <td>
                <div class="button-group">
                    <button class="button border-main edit" data-id="<?php echo $item['id']; ?>">
                        <span class="icon-edit"></span>修改
                    </button>
                    <button class="button border-red delete" data-id="<?php echo $item['id']; ?>">
...
<div class="panel admin-panel margin-top" id="add">
    <div class="panel-head"><strong><span class="icon-pencil-square-o"></span> 添加广告标语</strong></div>
    <table class="table table-hover">
        <tr>
            <td>广告标语标题</td>
            <td><input name="title" value="" id="title" class="input w80"></td>
            <td>链接地址</td>
            <td><input name="link" value="" id="link" class="input w80"></td>
...
<script>
    $(function () {
        ...
        $(".delete").click(function () {
            if(window.confirm("删除数据不可恢复，确定要删除吗？")){
                var id = $(this).data('id');
                $.post(
                    "<?php echo url('delete'); ?>",{id:id},
                    function (res) {
                        layer.msg(res.msg, {time: 3000, icon:6});
                		setTimeout(function(){location.reload();},3000);
                    }
