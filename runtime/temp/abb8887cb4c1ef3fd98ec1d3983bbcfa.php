<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"E:\phpWeb\watian\webserver\public/../application/admin\view\menu\index.html";i:1535120274;s:66:"E:\phpWeb\watian\webserver\application\admin\view\public\base.html";i:1538110204;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <button type="button" class="button border-yellow" onclick="window.location.href='<?php echo url('add'); ?>'">
                <span class="icon-plus-square-o"></span> 添加菜单
            </button>
        </div>
        <table class="table table-hover">
            ...
            <tr>
                <td><?php echo $item['_title']; ?><?php echo $item['name']; ?></td>
                ...
                <td>
                    <div class="button-group">
                        ...
                        <a class="button border-red" href="javascript:void(0)"
                           onClick="warning('确定要删除吗', '<?php echo url('delete',['id'=>$item['id']]); ?>')">
