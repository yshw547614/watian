<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\phpweb\watian\webserver\public/../application/admin\view\type\index.html";i:1538111684;s:66:"D:\phpweb\watian\webserver\application\admin\view\public\base.html";i:1538110204;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <tr>
            ...
            <td>
                <div class="button-group">
                    ...
                    <?php if($type == 'tags'): ?>
                    <a type="button" class="button border-main" href="<?php echo url('tags/index',['typeid'=>$item['id']]); ?>">
                        <span class="icon-info-circle"></span> 标签列表</a>
                    <?php endif; ?>
    ...
    <div class="body-content">
        <div class="form-x">
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" id="title" name="title" class="input tips" style="width:25%; float:left;"  value="" data-toggle="hover" data-place="right" data-image="" />
                    <button class="button bg-main icon-check-square-o margin-big-left" type="submit" id="submit"> 提交</button>
                </div>
            </div>
