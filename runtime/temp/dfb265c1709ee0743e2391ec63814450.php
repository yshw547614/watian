<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"D:\phpweb\watian\webserver\public/../application/admin\view\product_service_template\index.html";i:1537195544;s:66:"D:\phpweb\watian\webserver\application\admin\view\public\base.html";i:1538110204;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<form method="post" action="">
    <div class="panel admin-panel">
        <div class="panel-head"><strong class="icon-reorder"> 模板列表</strong></div>
        <div class="padding border-bottom">
            <button type="button" class="button border-yellow" onclick="window.location.href='<?php echo url('add'); ?>'">
                <span class="icon-plus-square-o"></span> 添加模板
            </button>
        </div>
